<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UnsubmittedTendersView.aspx.cs" Inherits="WWF.UnsubmittedTendersView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Unsubmitted Tenders</li>
        </ol>
    </section>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <%
                            ...
                            var data = nav.ProcurementRequest.Where(x => x.Process_Type == "Tender" && x.Document_Status == "Evaluation" && x.Vendor_No == vendorNo && x.Submitted_On_Portal == false).ToList();
                        ...
                        <tr>
                            ...
                            <td><label class="btn btn-warning"><i class="fa fa-question-circle"></i> Unsubmitted</label></td>
                            <td><a href="TenderApplicationPagev1.aspx?TenderNov1=<%=clearText %>" class="btn btn-success"><i class="fa fa-edit"></i>Complete Application</a> </td>
                        </tr>
                        <%
                            }
                        %>
