                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <%
                            ...
                            var data = nav.ProcurementRequest.Where(x => x.Process_Type == "Tender" && x.Document_Status == "Cancelled" && x.Vendor_No == vendorNo && x.Submitted_On_Portal == true).ToList();
                        ...
                        <tr>
                            ...
                            <td><label class="btn btn-warning"><i class="fa fa-question-circle"></i>Cancelled</label></td>
