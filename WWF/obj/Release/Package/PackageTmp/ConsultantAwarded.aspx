<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultantAwarded.aspx.cs" Inherits="WWF.ConsultantAwarded" %>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><label class="btn btn-success"><i class="fa fa-question-circle"></i>Awarded</label></td>
                             <td><a href="AwardedTenderDetails.aspx?TenderNo=<%=member.No %>" class="btn btn-primary"><i class="fa fa-edit"></i>View Details</a> </td>
                        </tr>
                        <%
                            }
                        %>
