...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <!-- Content Header (Page header) -->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="form-group">
                    <br />
                    <asp:Button runat="server" CssClass="btn btn-success btn-block" Text="Add Requisition Lines" ID="addrequisitionlines" OnClick="addrequisitionlines_Click"/>
                </div>
            </div>
        ...
        <div class="panel-footer">
            ...
            <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="Next" ID="nexttostepthree" OnClick="nexttostepthree_Click" CausesValidation="false" />
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-footer">
            <asp:Button runat="server" CssClass="btn btn-warning pull-left" Text="Previous" ID="backtosteptwo" OnClick="backtosteptwo_Click" CausesValidation="false"/>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button runat="server" CssClass="btn btn-danger" Text="Delete File" ID="deletefilebtn" OnClick="deletefilebtn_Click" CausesValidation="false"/>
                </div>
            </div>
    ...
    <div id="removeLineModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <asp:Button runat="server" CssClass="btn btn-danger" Text="Delete Line" ID="removelinebtn" OnClick="removelinebtn_Click" CausesValidation="false"/>
                </div>
            </div>
